// src/components/faq/general.jsx
...
export default function GeneralFAQ() {
  useEffect(() => {
    document.title = "General FAQ | GraduationScope";
    const meta = document.querySelector('meta[name="description"]') || document.createElement("meta");
    meta.name = "description";
    meta.content = "What is GraduationScope? How it works, supported universities, accuracy, pricing, mobile, and tips.";
  ...
  useEffect(() => { injectJsonLd(faqs); return () => {
    const node = document.getElementById("faq-jsonld");
    if (node) node.remove();
  }; }, [faqs]);
